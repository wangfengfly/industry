...
class Model_province extends CI_Model 
{
    function __construct()
    {
		 ...
		 *     - TRUE:  just the field names of the province table
	...
	function lister ( $page = FALSE )
	{
        ...
        if( $this->pagination_enabled == TRUE )
        {
            ...
            $config['base_url']    = 'province/index/';
	...
	function search ( $keyword, $page = FALSE )
	{
        ...
        die('Please see models/model_province.php for setting up the search method.');
        ...
        if( $this->pagination_enabled == TRUE )
        {
            $config = array();
            $config['total_rows']  = $this->db->count_all_results();
            $config['base_url']    = '/province/search/'.$keyword.'/';
    ...
    function metadata()
    {
        ...
        $metadata = $this->explain_table->parse( 'province' );
